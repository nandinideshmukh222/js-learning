function stringHandsOn(){
      ...
      console.log(`Step 1:Given sentence is:"${sentence}"`);
       ...
       console.log(`Step 3:After Trim Sentence is:"${sentenceaftertrim}" and it's length is: ${lengthaftertrim}`);
       console.log("         *********         ");
      ...
      var totalChars1=sentence.length;
       ...
       console.log(`Step 5 :1St  char After trim is: ${firstchar} and last char after Trim is: ${lastchar}`);

       var sentence = "Hey you are doing good, keep it up";
       var resultValue = sentence.split(" ")
       console.log("         *********         ");

       console.log(`Step 6:${resultValue} Total words available in the sentence: ${resultValue.length}`);
...
console.log(`Step 8 :substring starting from index 22 is: ${greet.substring(22)}`);
